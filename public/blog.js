...
async function showUserOnScreen() {
    ...
    for (let i = 0; i < blogs.length; i++) {
        ...
        li.className = 'relative border p-4 mb-4 bg-gradient-to-r from-yellow-200 via-pink-400 to-pink-300 rounded shadow-xl'; // Apply Tailwind CSS classes here
        ...
        maximisebutton.className = 'absolute top-0 right-0 bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded mt-2 mr-2';
        ...
        maximisebutton.addEventListener('click', () => {
            ...
            sendButton.className = 'bg-black hover:bg-green-700 text-white font-bold  rounded mr-2 my-2.5 px-2 ml-2';
    ...
    subcontainer.appendChild(sendButton)
            ...
            minimizeButton.className = 'absolute top-0 right-0 bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-4 rounded text-lg mt-2 mr-2'; // Add margin-top for spacing
    ...
    form2.addEventListener('submit',async(e)=>{
        ...
        console.log(obj2)
        const response=await axios.post('http://localhost:3000/comment',obj2)
    })
